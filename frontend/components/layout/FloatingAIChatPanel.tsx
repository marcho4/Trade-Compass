...
import { PromptExample, portfolioPrompts } from "@/lib/ai-prompts"
...
interface FloatingAIChatPanelProps {
  promptExamples?: PromptExample[]
}

export const FloatingAIChatPanel = ({ 
  promptExamples = portfolioPrompts
  ...
  return (
    <aside
      className={cn(
        "fixed left-6 top-1/2 -translate-y-1/2 z-50 transition-all duration-300",
        "bg-background/95 backdrop-blur-xl border border-border/60",
        "rounded-3xl shadow-2xl w-96"
      )}
    >
          ...
          <div className="grid grid-cols-2 gap-2">
            {promptExamples.map((example) => (
              <button
                ...
                className={cn(
                  "p-3 rounded-lg border border-border/60 bg-muted/50",
                  "hover:bg-muted hover:border-primary/40 transition-all duration-200",
